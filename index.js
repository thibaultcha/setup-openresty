...
async function main() {
    ...
    try {
        ...
        let openresty_src = await download("OpenResty", openresty_url, openresty_version)
    ...
    if (test_nginx) {
        ...
        try {
            ...
            let cpanm_src = await download("cpanm", "https://cpanmin.us", "0.0.0")
